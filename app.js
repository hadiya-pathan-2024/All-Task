...
app.get('/view/:id',authentication,function(req,res){
...
app.get('/details',authentication,function(req,res){
...
app.get('/data',authentication,function(req,res){
...
//update employee
app.get('/update/:id',authentication, function(req,res){
var userId = req.params.id;
if(userId){
...
app.get('/task16',authentication,function(req,res){
    res.render('Task16/form.ejs',{data : null,data1 : null,data2 : null,data3 : null,data4 : null,data5 : null,data6 : null,data7:null,i:0,j:0});
});

app.get('/dataTask16',authentication,function(req,res){
    con.query(`select id,firstname, lastname, designation, email, phone, gender, relation,DATE_FORMAT(dob,'%m/%d/%y') as dob from basic_detail`,
     function(err, result){
        if(err) throw err;
        // console.log(result);
        res.render('Task16/data.ejs',{users: result});
    });
});

//update employee
app.get('/task16/update/:id',authentication, function(req,res){
    var userId = req.params.id;
    if(userId){
    var sql = `select * from basic_detail where id = '${userId}'`;
    con.query(sql , function(err , data1){
                    ...
                    con.query(sql6 , function(err , data5){
                        ...
                        // console.log(data);
                            ...
                            con.query(sql7 , function(err , result7){
                                if(err) throw err;
                                // console.log(data7);
                                res.render('Task16/form.ejs',{data : data2,data1:data1[0], data3:data3, data4:data4 , data5:data5,data6:data6,data7:result7[0],i:0,j:0})
                                console.log(result7);
                                // console.log(data);
